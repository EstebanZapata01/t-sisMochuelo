...
datafile = outdir + 'chi2_nsi_2DAr.dat'
configfile = outdir + 'nsi_configAr.txt'
...
plt.title(r'Regiones de Exclusión RED-100 (LAr) - Proyección Asimov', fontsize=12, pad=15)
...
outplot = outdir + 'contornos_nsi_red100Ar.png'
