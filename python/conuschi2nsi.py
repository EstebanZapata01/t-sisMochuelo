...
datafile = outdir + 'chi2_nsi_2Dconus.dat'
configfile = outdir + 'nsi_config_conus.txt'
...
plt.title(r'Regiones de Exclusión CONUS+ (Ge)', fontsize=12, pad=15)
...
outplot = outdir + 'contornos_nsi_conus.png'
