...
ax1.set_title('Espectros de retroceso para RED‑100 (Ar) ', fontsize=14)
ax1.set_yscale('log')
ax1.legend()
...
ax2.scatter(Ne, extraidos, c='r', label=f'Electrones extraídos (EEE = {1.0})', s=16)
